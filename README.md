...
This repository contains R scripts and data sets that can be used to reproduce the results presented in [Prado, E.B., Moral, R.A. & Parnell, A.C. Bayesian additive regression trees with model trees. Statistics and Computing 31, 20 (2021)](https://link.springer.com/article/10.1007/s11222-021-09997-3).
